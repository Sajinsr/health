...
from marley_health.marley_health.doctype.patient_appointment.patient_appointment import (
...
class TestPatientAppointment(FrappeTestCase):
	...
	def test_overlap_appointment(self):
		from marley_health.marley_health.doctype.patient_appointment.patient_appointment import OverlapError
