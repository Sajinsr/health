...
frappe.ui.form.on('Clinical Procedure', {
	...
	set_procedure_consumables: function(frm) {
		frappe.call({
			method: 'marley_health.marley_health.doctype.clinical_procedure.clinical_procedure.get_procedure_consumables',
			args: {
	...
	set_medical_codes: function(frm) {
		frappe.call({
			"method": "marley_health.marley_health.utils.get_medical_codes",
			args: {
				template_dt: "Clinical Procedure Template",
...
frappe.ui.form.on('Clinical Procedure Item', {
	...
	item_code: function(frm, cdt, cdn) {
		...
		if (d.item_code) {
			...
			return frappe.call({
				method: 'marley_health.marley_health.doctype.clinical_procedure_template.clinical_procedure_template.get_item_details',
				args: {args: args},
				callback: function(r) {
					if (r.message) {
						let d = locals[cdt][cdn];
...
let get_procedure_prescribed = function(frm){
	if(frm.doc.patient){
		frappe.call({
			method:"marley_health.marley_health.doctype.clinical_procedure.clinical_procedure.get_procedure_prescribed",
