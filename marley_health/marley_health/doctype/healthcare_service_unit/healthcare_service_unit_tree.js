...
frappe.treeview_settings['Healthcare Service Unit'] = {
	...
	get_tree_root: false,
	get_tree_nodes: 'marley_health.marley_health.utils.get_children',
	filters: [{
		fieldname: 'company',
		fieldtype: 'Select',
			...
			click: function (node) {
				const dialog = new frappe.ui.Dialog({
					...
					primary_action: () => {
						...
						return frappe.call({
							method: 'marley_health.marley_health.doctype.healthcare_service_unit.healthcare_service_unit.add_multiple_service_units',
							args: {
