	...
	refresh: function (frm) {
		...
		if (frm.doc.docstatus === 1 && frm.doc.sms_sent === 0 && frm.doc.status !== 'Rejected' ) {
			frm.add_custom_button(__('Send SMS'), function () {
				frappe.call({
					method: 'marley_health.marley_health.doctype.healthcare_settings.healthcare_settings.get_sms_text',
...
var status_update = function (approve, frm) {
	...
	frappe.call({
		method: 'marley_health.marley_health.doctype.lab_test.lab_test.update_status',
...
var get_lab_test_prescribed = function (frm) {
	if (frm.doc.patient) {
		frappe.call({
			method: 'marley_health.marley_health.doctype.lab_test.lab_test.get_lab_test_prescribed',
			args: { patient: frm.doc.patient },
			callback: function (r) {
