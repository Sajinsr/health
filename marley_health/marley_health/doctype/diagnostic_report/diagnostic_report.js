...
frappe.ui.form.on("Diagnostic Report", {
	...
	after_workflow_action: function(frm) {
		frappe.call({
			"method": "marley_health.marley_health.doctype.diagnostic_report.diagnostic_report.set_observation_status",
			args: {
...
var show_diagnostic_report = function(frm) {
	...
	if (frm.doc.patient) {
		this.diagnostic_report = new marley_health.Diagnostic.DiagnosticReport({
			frm: frm,
