				...
				if (frm.doc.encounter_status == "Admission Scheduled" && frm.doc.status == "Active") {
					...
					if (frm.doc.outstanding_amount > 0) {
						frm.add_custom_button(__('Payment Entry'), function() {
							frappe.call({
								method: "marley_health.marley_health.doctype.treatment_counselling.treatment_counselling.create_payment_entry",
								args: {
...
var schedule_inpatient = function(frm) {
	...
	frappe.call({
		method: "marley_health.marley_health.doctype.treatment_counselling.treatment_counselling.create_ip_from_treatment_counselling",
		args: {
