...
from marley_health.marley_health.doctype.healthcare_settings.healthcare_settings import (
	get_income_account,
)
from marley_health.marley_health.doctype.lab_test.lab_test import create_multiple
from marley_health.marley_health.doctype.observation.observation import add_observation
from marley_health.marley_health.doctype.observation_template.observation_template import (
	get_observation_template_details,
)
from marley_health.setup import setup_healthcare
...
def get_appointment_type_billing_details(appointment_type, dep_su, is_inpatient):
	from marley_health.marley_health.doctype.appointment_type.appointment_type import get_billing_details
...
def update_address_links(address, method):
	...
	"""
	if "Marley Health" not in frappe.get_active_domains():
		return
...
def update_patient_email_and_phone_numbers(contact, method):
	...
	"""
	if "Marley Health" not in frappe.get_active_domains() or contact.flags.skip_patient_update:
		return
