...
marley_health.Observation = class Observation {
	constructor(opts) {
		$.extend(this, opts);
	}
		...
		let _add_observations = () => {
			var d = new frappe.ui.Dialog({
				...
				primary_action: function() {
					...
					frappe.call({
						method: "marley_health.marley_health.doctype.observation.observation.add_observation",
						args: {
		...
		let result = $(row).find(".result-content").html().trim();
			var d = new frappe.ui.Dialog({
				...
				primary_action: function() {
					...
					frappe.call({
						method: "marley_health.marley_health.doctype.observation.observation.edit_observation",
						args: {
