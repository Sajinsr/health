...
def execute():
	...
	for old, new in doctypes.items():
		if frappe.db.exists("DocType", old) and not frappe.db.exists("DocType", new):
			...
			frappe.reload_doc("marley_health", "doctype", new)
	...
	try:
		...
		frappe.reload_doc("marley_health", "doctype", "Codification Table")
		...
		frappe.reload_doc("marley_health", "doctype", "Healthcare Settings")
